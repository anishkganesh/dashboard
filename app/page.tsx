    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-8 relative">
      <div className="max-w-4xl w-full space-y-16">
        ...
        <header className="text-center space-y-4">
          ...
          <p className={`${GeistMono.className} text-xl text-muted-foreground`}>
        ...
        <section className="space-y-8">
          <h2 className={`${GeistMono.className} text-2xl font-light text-center`}>projects</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Card className="group hover:bg-accent transition-soft cursor-pointer border-border/50">
              <CardContent className="p-6 flex flex-col items-center justify-center h-32">
                ...
                <p className={`${GeistMono.className} mt-2 text-sm text-muted-foreground group-hover:text-foreground transition-soft`}>
                  coming soon
                </p>
              </CardContent>
            </Card>
        ...
        <section className="space-y-6">
          <h2 className={`${GeistMono.className} text-2xl font-light text-center`}>connect</h2>
        ...
        <section className="space-y-6 pb-8">
          <h2 className={`${GeistMono.className} text-2xl font-light text-center`}>contact</h2>
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8">
            ...
            >
              ...
              <span className={`${GeistMono.className} text-muted-foreground group-hover:text-foreground transition-soft`}>
